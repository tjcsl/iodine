...
INSERT INTO filecenter_filesystems VALUES ("main","$this->filesystem = new CSLProxy($_SESSION['i2_username'], $I2_AUTH->get_user_password(),'LOCAL.TJHSST.EDU');$this->template_args['max_file_size'] = 20971520;");
