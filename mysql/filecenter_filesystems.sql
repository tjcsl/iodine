...
INSERT INTO filecenter_filesystems VALUES ("portfolio","$this->filesystem = new CIFS($_SESSION['i2_username'], $I2_AUTH->get_user_password(),'portfolio',$this->commonserver);$this->template_args['max_file_size'] = 10485760;");
