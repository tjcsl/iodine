<?php
/**
* Just contains the definition for the {@link Eighthmakeup} module.
* @author The Intranet 2 Development Team <intranet2@tjhsst.edu>
* @copyright 2005 The Intranet 2 Development Team
* @since 1.0
* @package core
* @subpackage Eighthmakeup
* @filesource
*/
...
class Eighthmakeup {
	...
	*/
	function init_pane() {
		return array('Eighth Period Information', 'How to Use your Eighth Period Record for Make-Up Credit or Service Hours');
	}
