<?php
/**
* Just contains the definition for the {@link Eighthsignup} module.
* @author The Intranet 2 Development Team <intranet2@tjhsst.edu>
* @copyright 2005 The Intranet 2 Development Team
* @since 1.0
* @package core
* @subpackage Eighthsignup
* @filesource
*/
...
class Eighthsignup {
	...
	*/
	function init_pane() {
		return array('Eighth Period Information', 'How to Sign Up for Eighth Period');
	}
