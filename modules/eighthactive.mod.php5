<?php
/**
* Just contains the definition for the {@link Eighthactive} module.
* @author The Intranet 2 Development Team <intranet2@tjhsst.edu>
* @copyright 2005 The Intranet 2 Development Team
* @since 1.0
* @package core
* @subpackage Eighthactive
* @filesource
*/
...
class Eighthactive {
	...
	*/
	function init_pane() {
		return array('Eighth Period Information', 'Active Eighth Period Clubs');
	}
