<?php
/**
* Just contains the definition for the {@link Eighthwhat} module.
* @author The Intranet 2 Development Team <intranet2@tjhsst.edu>
* @copyright 2005 The Intranet 2 Development Team
* @since 1.0
* @package core
* @subpackage Eighthwhat
* @filesource
*/
...
class Eighthwhat {
	...
	*/
	function init_pane() {
		return array('Eighth Period Information', 'What is Eighth Period?');
	}
