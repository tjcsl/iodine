<?php
/**
* Just contains the definition for the {@link Eighthinactive} module.
* @author The Intranet 2 Development Team <intranet2@tjhsst.edu>
* @copyright 2005 The Intranet 2 Development Team
* @since 1.0
* @package core
* @subpackage Eighthinactive
* @filesource
*/
...
class Eighthinactive {
	...
	*/
	function display_pane($display) {
		$display->disp('eighthinactive.tpl');
	}
	...
	*/
	function init_pane() {
		return array('Eighth Period Information', 'Inactive Eighth Period Activities');
	}
