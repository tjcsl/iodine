...
[</if>]
		...
		<tr>
			<td>Restricted:</td>
			<td><input type="checkbox" name="restricted"[<if $activity->restricted >] checked[</if>]></td>
		</tr>
		<tr>
			<td>48 Hour:</td>
			<td><input type="checkbox" name="presign"[<if $activity->presign >] checked[</if>]></td>
		</tr>
		<tr>
			<td>One-A-Day:</td>
			<td><input type="checkbox" name="oneaday"[<if $activity->oneaday >] checked[</if>]></td>
		</tr>
		<tr>
			<td>Both Blocks:</td>
			<td><input type="checkbox" name="bothblocks"[<if $activity->bothblocks >] checked[</if>]></td>
		</tr>
		<tr>
			<td>Sticky:</td>
			<td><input type="checkbox" name="sticky"[<if $activity->sticky >] checked[</if>]></td>
		</tr>
	</table><br />
