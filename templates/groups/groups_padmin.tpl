...
<form method="post" action="[<$I2_ROOT>]groups/padmin/[<$prefix>]" class="boxform">
<input type="hidden" name="group_padmin_form" value="add" />
<input type="text" name="name" value="" /><input type="submit" value="Add" name="submit" /><br />
</form>
To remove a group, enter its name here:<br />
<form method="post" action="[<$I2_ROOT>]groups/padmin/[<$prefix>]" class="boxform">
<input type="hidden" name="group_padmin_form" value="remove" />
