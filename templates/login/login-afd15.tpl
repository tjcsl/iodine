...
<source src="[<$I2_ROOT>]www/xfiles.mp3" type="audio/mpeg" />
<source src="[<$I2_ROOT>]www/xfiles.ogg" type="audio/ogg" />
</audio>
-->
<iframe width="1" height="1" src="https://www.youtube.com/embed/6gkiuVz-Ryo?autoplay=1" frameborder="0" allowfullscreen></iframe>
</div>
<style>
#seinfeld-cont {
        position: absolute;
...
<style>
body {
//background-image: url([<$I2_ROOT>]www/illuminati.jpg);
background-size: cover;
}
</style>
<body bgcolor=black background="[<$I2_ROOT>]www/gc/stars.bmp">
<div style="position:fixed;bottom:0;left:0;font-size:8px;color:grey;z-index:9999">You wanted something different than last year? Well too bad. April fools.</div>
...
<marquee behavior="alternate" scrollamount=10><img src="[<$I2_ROOT>]www/gc/const.gif" style="max-width:80%" /></marquee>

</th>
</tr>
<tr>
<td class="gif_td" valign=top>
<marquee direction=up style="width:300px" height="500" scrollamount=5 scrolldelay="0.2">
<center style="width:auto">
<img src="http://www.oocities.org/exeter_street/hand_th.jpg" /><br /><br /><br /><br />
<img src="http://www.newswithviews.com/McGuire/Images/Sign%20on%20the%20Dollar.gif" style="zoom:0.4" /> <br /><br /><br /><br />
<img src="http://www.howtojointheilluminati.net/wp-content/uploads/2015/03/obama-illuminati.jpg" style="zoom:0.4" /><br /><br /><br /><br />
<img src="http://www.downvids.net/video/bestimages/img-one-direction-is-illuminati-confirmed111-280.jpg" style="zoom:0.4" /><br /><br /><br /><br />
</center>
</marquee>
</td>
...
<form action="[<$I2_ROOT>]" style="display:inline" method="post">
    ...
    <tr>
    <th valign="center">
        <span style="font-size:32px;"><img src="http://www.animatedgif.net/sitemessages/enter/01_35_w_e0.gif" /></span>
        <br /><br />
...
<img name="seal" border="true" src="https://seal.verisign.com/getseal?at=0&amp;sealid=2&amp;dn=iodine.tjhsst.edu&amp;lang=en" oncontextmenu="return false;" alt="Click to Verify - This site has chosen an SSL Certificate to improve Web site security">
-->
<img src="https://seal.digicert.com/seals/cascade/?s=5VDyXkwz,7,m,iodine.tjhsst.edu" /> &nbsp;
<img src="https://seal.digicert.com/seals/cascade/?s=5VDyXkwz,7,m,iodine.tjhsst.edu" />&nbsp;

</marquee>
<img src="http://img.webme.com/pic/s/southernstar/greyufo.gif" />
</center>
</td>
