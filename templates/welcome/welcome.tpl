...
All students at TJHSST are assigned their own e-mail address.  Your TJ e-mail address is [<$user->tjmail>].  You can access your TJ e-mail by going to <a href="https://webmail.tjhsst.edu/">https://webmail.tjhsst.edu/</a>, clicking on the "Mail" link on the Intranet login page, or by clicking on the link in the E-mail intrabox.  You can also use a mail client such as Thunderbird or Outlook to access your TJ e-mail (using either the IMAP or POP3 settings).<br />
