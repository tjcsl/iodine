...
Please make every effort to accurately provide the information requested.  It is easier to certify that you are the owner of a particular calculator this way.<br />
...
<option value="[<$id.calcsn>]">[<$id.calcsn>]</option>
[</foreach>]
</select>
</td></tr><tr><td>
