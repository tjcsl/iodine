...
<dt>Wildcards</dt>
<dd>
<p>Use wildcards (<tt>*</tt>, <tt>?</tt>) in searches if you're not sure of a name. These work 
...
<p>A search term without a field name prefixed will, if it contains 
	...
	<tt>rob</tt> will return "Robert D Holeman", "Keith Robert 
	Thornburg", and "Kilani Kei Robinson". </p>
<p>If it contains no alphabetic	characters, but includes numbers, 
	it will be matched against grades. Searching for <tt>12</tt> 
	will give you all seniors. Searching for <tt>1?</tt> gives you all 
	10, 11, and 12th graders.</p>
</dd>

<dt><tt>name</tt></dt>
<dd>
<p>Searches in all name fields (first, middle, last). No name truncation 
...
<dd>
<p>Searches in first and middle name fields. No name truncation 
	is supported, as for unprefixed words---see above.<br />
...
<dt><tt>grade</tt></dt>
<dd>
<p>Searches by grade. Like <tt>name</tt>, <tt>grade</tt> 
	does not support truncation, i.e., <tt>grade:1</tt> 
	gets you no one (no first graders at our school. We hope.).<br />
	<tt>grade:12</tt> gets you seniors only.</p>
</dd>
...
<dd>
<p>Does a soundex search on first and middle names. This tries to
	find names that sound like what you typed in. The first letter
	has to be correct.<br />
