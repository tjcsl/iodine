...
[<if isset($voted_male) && isset($voted_female)>]
 You have voted for <a href="[<$I2_ROOT>]studentdirectory/info/[<$voted_male->uid>]">[<$voted_male->name>]</a> [ <a href="[<$I2_ROOT>]homecoming/clearvote/male">clear vote</a> ] and <a href="[<$I2_ROOT>]studentdirectory/info/[<$voted_female->uid>]">[<$voted_female->name>]</a> [ <a href="[<$I2_ROOT>]homecoming/clearvote/female">clear vote</a> ].<br />
