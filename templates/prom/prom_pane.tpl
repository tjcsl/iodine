<p>Please fill out the information below to receive tickets for prom. Remind your date to register themselves (if they are not a member of the TJ class of 2006, please see below). Thanks.</p>
        <form action="[<$I2_ROOT>]prom" method="post">
				...
				<input type="text" name="firstpdteacher"/> <input type="text" name="firstpdroom"/>
                <br />
<p>If you are bringing a non-2006 date please provide the following information: </p>
                <p>Date's Name: <input type="text" name="datename" /></p>
                <p>Date's School (if TJ enter class): <input type="text" name="dateschool" /></p>
