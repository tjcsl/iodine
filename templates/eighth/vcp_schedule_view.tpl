...
[<if $I2_USER->is_group_member('admin_eighth')>]
	...
	<a href="[<$I2_ROOT>]pictures/[<$user->uid>]"><img src="[<$I2_ROOT>]pictures/[<$user->uid>]" alt="[<$user->name_comma>]"vspace="2" width="86" style="float: left; margin: 10px;"/></a>
...
[</if>]
	...
	<td><input type="button" value="View Most Often Attended Activities" onclick="location.href='[<$I2_ROOT>]eighth/vcp_schedule/mostoften/uid/[<$user->uid>]'" /></td>
