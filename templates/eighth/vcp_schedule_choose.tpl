...
[<foreach from=$activities item="activity">]                                    
        <option value="[<$activity->aid>]"[<if $activity->cancelled >] style="color: #FF0000; font-weight: bold;"[<elseif $activity->restricted >] style="color: #FF6600; font-weight: bold;"[<elseif $activity->member_count >= $activity->capacity>] style="color: #0000FF; font-weight: bold;"[</if>]>[<$activity->aid>]: [<$activity->name_r>]</option>                                                                         
[</foreach>] 
	</select><br />
...
<div id="desc_[<$activity->aid>]" style="display: none; border: solid thin; padding: 5px; margin: 5px; width: 300px;">
	...
	[<$activity->member_count>] Students signed up out of [<$activity->capacity>] possible<br />
	[<if $activity->cancelled>]<br /><span class="bold" style="color: #FF0000;">CANCELLED</span>[</if>]
	[<if $activity->member_count >= $activity->capacity>]<br /><span class="bold" style="color: #0000FF;">CAPACITY FULL</span>[</if>]
