...
<form name="activity_select_form" action="[<$I2_ROOT>]eighth/vcp_schedule/change/uid/[<$uid|escape>]/bids/[<$bids|escape>][<if $start_date != NULL>]/start_date/[<$start_date|escape>][</if>]" method="post">
	<div id="activityList">
		[<if $selected>]
