...
<div id="desc_[<$activity->aid>]" style="display: none; border: solid thin; padding: 5px; margin: 5px; width: 300px;">
	...
	[<$activity->member_count>] student(s) are signed up [<if $activity->capacity != -1>]out of [<$activity->capacity>] allowed [</if>]for this activity.<br />
	[<if $activity->cancelled>]<br /><span class="bold" style="color: #FF0000;">CANCELLED</span>[</if>]
	[<if $activity->capacity != -1 && $activity->member_count >= $activity->capacity>]<br /><span class="bold" style="color: #0000FF;">CAPACITY FULL</span>[</if>]
