////////////////////////////////////////////////////////////////////////////////
//                              Podcasts magic javascript                        //
////////////////////////////////////////////////////////////////////////////////

var root = document.location.href;
root = root.substring(0,root.indexOf("podcasts"));
function addQuestion(event) {
	event.preventDefault();
	var table = document.getElementById("podcast_question_list");
	...
	img.src = root+"www/pics/podcastx.gif";
...
function podcasts_addGroup(event) {
	event.preventDefault();
	var table = document.getElementById("podcasts_groups_table");
	var body = table.tBodies.item(0);
	...
	var groupsList = document.getElementById("podcasts_groups");
	var select = document.createElement("select");
	...
	remove.onclick = podcasts_deleteGroup;
	remove.href = "";
	row.insertCell(5).appendChild(remove);
}

function podcasts_deleteGroup(event) {
	event.preventDefault();
